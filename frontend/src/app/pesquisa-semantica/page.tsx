...
export default function PaginaPesquisaSemantica() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      <h1 className="text-2xl font-bold text-gray-800">Descobrir (pesquisa semântica)</h1>
      <p className="mt-1 text-gray-500">
        Esta pesquisa entende relações. Procure um tema e veja como a plataforma
        encontra também os assuntos relacionados.
      </p>
      ...
      {estado === "erro" && (
        <div className="mt-8 rounded-lg bg-red-50 p-4 text-red-700">
          Não foi possível pesquisar. A API e o Fuseki estão a correr? ({erro})
        </div>
      )}
        ...
        <div className="mt-8 space-y-6">
          <div className="cartao">
            <h2 className="mb-2 font-semibold text-gray-800">
              Temas relacionados encontrados por inferência
            </h2>
            <p className="mb-3 text-sm text-gray-500">
              A ontologia expandiu &quot;{resposta.termo}&quot; para:
            </p>
          ...
          <div>
            ...
            {resposta.resultados.length === 0 ? (
              <p className="text-gray-500">
                Sem resultados. Carregue a ontologia no Fuseki
